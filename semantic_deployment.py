...
"""first we should download the files from the other collab notebook(semantic analysis) and upload the files svm_model.pkl, tfidf_vectorizer.pkl
extension of the file is .pkl (pickel)
"""
...
st.markdown("By Samyuktha")
image = Image.open("Screenshot 2023-09-08 113208.png")
